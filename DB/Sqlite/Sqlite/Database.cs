...
namespace SkyFloe.Sqlite
{
   ...
   public class Database : IDisposable
   {
      ...
      /// <summary>
      /// Database static initializer
      /// </summary>
      /// <remarks>
      /// This method loads the appropriate platform-specific version of
      /// sqlite3.dll on Windows that will work with Mono.Data.Sqlite.
      /// Other platforms will use the installed libsqlite3.so.
      /// </remarks>
      static Database ()
      {
         try
